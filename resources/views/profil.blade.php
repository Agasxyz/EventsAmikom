<!DOCTYPE html>
<html>
<head><title>Halaman Profil</title>
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            ...
            <a href="/profil" aria-current="page" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white">Profil</a>
            <a href="/katalog" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Katalog</a>
            <a href="bantuan" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">FAQ</a>
          </div>
        </div>
      </div>
...
<h1 class="text-2xl font-bold text-slate-800 mb-2">Profil</h1>
<p>Nama : Akbar Bagas Pamungkas <br>
NIM : 24.12.3388 <br>
Kelas : SI06</p>
</div>
</body>
