        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y border-t">
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-6">
                        <p class="font-medium text-slate-700 truncate max-w-xs">{{ $trx->event->title ?? '-' }}</p>
                    </td>
                ...
                @empty
                <tr>
                    <td colspan="6" class="px-8 py-12 text-center text-slate-500 font-medium">Belum ada transaksi terekam untuk event Anda.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
